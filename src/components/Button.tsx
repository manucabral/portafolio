...
export default function Button({
    ...
    const types = {
        ...
        secondary:
            'text-te-100 bg-white hover:bg-te-100 focus:ring-4 focus:outline-none focus:ring-te-400 dark:focus:ring-te-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2',
    }
    return (
